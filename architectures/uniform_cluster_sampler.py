...
class ClusterSampler:
    ...
    def __init__(self, n_clusters, batch_size):
        ...
        #This list contains K=number_of_clusters lists containing the positions (indices) of all the samples in the dataset belonging to that cluster
    ...
    def sample(self, x, y):
        ...
        for cluster_type in cluster_types:
            ...
            random_cluster_index = np.random.choice(cluster_indices) #choose a random sample of the dataset with the specified cluster
