...
N_POSSIBLE_CLUSTERS = [32, 64, 128, 256, 512, 1024]  # k-means/GMM: possible values for the K parameter

EPS_VALUES = [0.5]  # DBSCAN: possible values for the EPS parameter
MIN_SAMPLES = [2, 4, 8, 16]  # DBSCAN/OPTICS: possible values for the MIN_SAMPLES parameter
