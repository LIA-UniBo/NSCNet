...
AUDIO_FILES = [osp.join(DATA_DIR, folder, f) for folder in BIRDS_FOLDERS for f in os.listdir(osp.join(DATA_DIR, folder))
               if f.endswith(".wav")]
OFFSET_FILES = [osp.join(DATA_DIR, folder, f) for folder in BIRDS_FOLDERS for f in
                os.listdir(osp.join(DATA_DIR, folder)) if f.endswith(".txt")]
